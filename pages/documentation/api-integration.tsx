...
const ApiIntegration: NextPage = () => {
  return (
    <div>
      <Head>
        <title>Reef Pay | API Integration</title>
      ...
      <SDocumentation>
        <SContainer>
          ...
          <SText>
            ...
            mandatory fields. The amount field is the price to charge the payer
            in reef, successUrl is the page a payer is redirect to after a
        ...
        <SContainer>
          ...
          <SText>
            A successful Payment Request response is sent back in JSON with
            fields of url which is the payment url to redirect the user to, and
            a transactionId field which is the id of the payment request to
            track. the url field is time sensitve and becomes invalid after 5
            minutes with webhook call event of a payment failed type.
          </SText>
          <SContent>
        ...
        <SContainer>
          ...
          <SText>
            ...
            each payment request, when the transaction processing is done an
            event is sent for each payment state.
          </SText>
          <SContent>
          ...
          <SText>
            The response JSON object contains an event field which could be a
            list of four possible transaction states, a
            ...
            and a &quot;payment.underpaid.failed&quot; is sent when the user
            makes a lower than expected payment with the money refunded with
            service fee. transactionId field field is used to identify the
            payment and the amount field specifies the reef the API handled
          </SText>
          <SContent>
